...
try {
    ...
    if ($existingStorage) { Write-Log "Storage account '$storageAccountName' already exists. Removing..."; Remove-AzStorageAccount -Name $storageAccountName -ResourceGroupName $resourceGroupName -Force -Confirm:$false; Write-Log "Storage account '$storageAccountName' removed." }
...
try {
    ...
    if ($existingPublicIp) { Write-Log "Public IP '$publicIpName' already exists. Removing..."; Remove-AzPublicIpAddress -Name $publicIpName -ResourceGroupName $resourceGroupName -Force -Confirm:$false; Write-Log "Public IP '$publicIpName' removed." }
...
try {
    ...
    if ($existingVnet) { Write-Log "Virtual Network '$vnetName' already exists. Removing..."; Remove-AzVirtualNetwork -Name $vnetName -ResourceGroupName $resourceGroupName -Force -Confirm:$false; Write-Log "Virtual Network '$vnetName' removed." }
...
try {
    ...
    if ($existingNic) { Write-Log "Network Interface '$nicName' already exists. Removing..."; Remove-AzNetworkInterface -Name $nicName -ResourceGroupName $resourceGroupName -Force -Confirm:$false; Write-Log "Network Interface '$nicName' removed." }
...
try {
    ...
    if ($existingVm) { Write-Log "Virtual Machine '$vmName' already exists. Removing..."; Remove-AzVM -Name $vmName -ResourceGroupName $resourceGroupName -Force -Confirm:$false; Write-Log "Virtual Machine '$vmName' removed." }
