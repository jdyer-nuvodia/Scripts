...
# Updated script to use Azure Blob Storage for storing and downloading the runbook
...
Set-AzStorageBlobContent -Context $storageAccountContext -Container $containerName -File $tempRunbookFilePath -Blob $blobName
