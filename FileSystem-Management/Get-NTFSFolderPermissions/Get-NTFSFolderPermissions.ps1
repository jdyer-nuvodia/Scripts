...
# Last Updated: 2025-03-12 19:47:12 UTC
# Updated By: jdyer-nuvodia
# Version: 1.14.0
# Additional Info: Enhanced SID resolution with diagnostic logging and validation
# =============================================================================
                ...
                try {
                    ...
                    try {
                        ...
                        if ($account -and $account.Caption) {
                            ...
                            return $# filepath: c:\Users\jdyer\OneDrive - Nuvodia\Documents\GitHub\Scripts\FileSystem-Management\Get-NTFSFolderPermissions\Get-NTFSFolderPermissions.ps1
# =============================================================================
# Script: Get-NTFSFolderPermissions.ps1
# Created: 2025-03-06 21:06:43 UTC
# Author: jdyer-nuvodia
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    # Method 5: Try using low-level Win32 API as absolute last resort
                    try {
